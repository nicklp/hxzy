										...
										<div class="col-md-8">
											<div class="row">
												...
												<div class="col-md-4 padding_left_right_0">
													<input type="text" id="dateYear" name="dateYear"  class="form-control" readonly placeholder="查询年份" />
												</div>
												<div class="col-md-3">
			                            ...
			                            <div class="panel panel-default chartJs">
			                                <div class="panel-heading">
			                                    <div class="card-title">
			                                        <div class="title">
			                                        	<ul>
			                                        		<li><i class="fa fa-square bg1" aria-hidden="true">&nbsp;</i>录入</li>
			                                        		<li><i class="fa fa-square bg2" aria-hidden="true">&nbsp;</i>上门</li>
			                                        		<li><i class="fa fa-square bg3" aria-hidden="true">&nbsp;</i>预报</li>
			                                        		<li><i class="fa fa-square bg4" aria-hidden="true">&nbsp;</i>付费</li>
			                                        	</ul>
			                                        </div>
			                                    </div>
			                                </div>
